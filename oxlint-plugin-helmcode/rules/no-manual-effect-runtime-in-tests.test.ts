...
const rule = createOxlintRuleHarness("helmcode/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("helmcode/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("helmcode/no-manual-effect-runtime-in-tests");
