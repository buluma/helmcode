  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Helm Code prerelease is available for nightly testers."
          : "A new Helm Code latest release is available.",
...
).pipe(Command.withDescription("Post a Helm Code release announcement to Discord."));
