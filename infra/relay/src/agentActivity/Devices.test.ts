import type { RelayDeviceRegistrationRequest } from "@helmcode/contracts/relay";
...
const registration: RelayDeviceRegistrationRequest = {
  ...
  bundleId: "com.helmcode.helmcode.preview" as RelayDeviceRegistrationRequest["bundleId"],
