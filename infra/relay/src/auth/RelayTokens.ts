...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@helmcode/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "helmcode-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "helmcode-relay-dpop-access+jwt";
...
>()("helmcode-relay/auth/RelayTokens") {}
