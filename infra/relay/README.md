...
The relay is the hosted control plane for HelmCode Connect. It helps clients discover and connect to
...
The relay is intentionally not in the hot path for normal Helm Code traffic. After a client connects,
regular API and WebSocket traffic goes directly between that client and the selected environment.
See the [HelmCode Connect architecture overview](../../docs/internals/helmcode-code-connect-auth-flow.html) for the larger system
design.
...
- [HelmCode Connect Clerk Setup](../../docs/internals/helmcode-connect.md) for Clerk keys, JWT templates, and sign-up restrictions
  setup.
- [Relay Observability](../../docs/operations/relay-observability.md) for deployment tracing and diagnostics.
- [HelmCode Connect Architecture Overview](../../docs/internals/helmcode-code-connect-auth-flow.html) for the full link,
