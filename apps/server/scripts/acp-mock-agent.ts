...
const requestLogPath = process.env.HELMCODE_ACP_REQUEST_LOG_PATH;
const exitLogPath = process.env.HELMCODE_ACP_EXIT_LOG_PATH;
const emitToolCalls = process.env.HELMCODE_ACP_EMIT_TOOL_CALLS === "1";
const emitInterleavedAssistantToolCalls =
  process.env.HELMCODE_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS === "1";
...
const emitLateUpdateAfterCancel = process.env.HELMCODE_ACP_EMIT_LATE_UPDATE_AFTER_CANCEL === "1";
const omitXAiPromptCompleteStopReason =
  process.env.HELMCODE_ACP_OMIT_XAI_PROMPT_COMPLETE_STOP_REASON === "1";
...
const emitOverlappingXAiPromptCompleteOutOfOrder =
  process.env.HELMCODE_ACP_EMIT_OVERLAPPING_XAI_PROMPT_COMPLETE_OUT_OF_ORDER === "1";
const failPrompt = process.env.HELMCODE_ACP_FAIL_PROMPT === "1";
const failSetConfigOption = process.env.HELMCODE_ACP_FAIL_SET_CONFIG_OPTION === "1";
const exitOnSetConfigOption = process.env.HELMCODE_ACP_EXIT_ON_SET_CONFIG_OPTION === "1";
const promptResponseText = process.env.HELMCODE_ACP_PROMPT_RESPONSE_TEXT;
const promptDelayMs = Number(process.env.HELMCODE_ACP_PROMPT_DELAY_MS ?? "0");
const permissionOptionIds = {
  allowOnce: process.env.HELMCODE_ACP_ALLOW_ONCE_OPTION_ID ?? "allow-once",
  allowAlways: process.env.HELMCODE_ACP_ALLOW_ALWAYS_OPTION_ID ?? "allow-always",
  rejectOnce: process.env.HELMCODE_ACP_REJECT_ONCE_OPTION_ID ?? "reject-once",
};
