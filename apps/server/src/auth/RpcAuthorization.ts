...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.serverGetLinearApiKey]: AuthOrchestrationReadScope,
  [WS_METHODS.serverSetLinearApiKey]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverRemoveLinearApiKey]: AuthOrchestrationOperateScope,
