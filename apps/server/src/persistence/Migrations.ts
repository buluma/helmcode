...
import Migration0041 from "./Migrations/041_ProjectionTurnsStopReasonCost.ts";
import Migration0042 from "./Migrations/042_ProjectionTurnsTokenUsage.ts";
import Migration0043 from "./Migrations/043_ProjectionThreadsSchedule.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionTurnsStopReasonCost", Migration0041],
  [42, "ProjectionTurnsTokenUsage", Migration0042],
  [43, "ProjectionThreadsSchedule", Migration0043],
] as const;
