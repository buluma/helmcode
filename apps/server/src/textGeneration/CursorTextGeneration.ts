...
import { type CursorSettings, type ModelSelection } from "@helmcode/contracts";
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@helmcode/shared/git";
  ...
  const runCursorJson = <S extends Schema.Top>({
    ...
    Effect.gen(function* () {
      ...
      const runtime = yield* makeCursorAcpRuntime({
        ...
        cwd,
        clientInfo: { name: "helmcode-code-git-text", version: "0.0.0" },
