...
import type { ChatAttachment, ModelSelection, ProviderInstanceId } from "@helmcode/contracts";
...
export type TextGenerationProvider = "codex" | "claudeAgent" | "cursor" | "grok" | "opencode" | "openrouter" | "nvidia";
...
>()("helmcode/textGeneration/TextGeneration") {}
