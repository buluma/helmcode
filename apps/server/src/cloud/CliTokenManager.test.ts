import { readConnectAuthorizeRequest } from "@helmcode/shared/connectAuth";
...
const TEST_ENV = {
  HELMCODE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  HELMCODE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  HELMCODE_HOSTED_APP_URL: "https://hosted.example.test",
};
