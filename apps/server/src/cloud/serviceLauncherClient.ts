import type { ServerSelfUpdateOutcome } from "@helmcode/contracts";
import { HostProcessEnvironment } from "@helmcode/shared/hostProcess";
  ...
  override get message(): string {
    switch (this.operation) {
      ...
      case "version-mismatch":
        return "The service launcher started a different helmcode version.";
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "helmcode/cloud/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("helmcode/cloud/serviceLauncherClient") {}
