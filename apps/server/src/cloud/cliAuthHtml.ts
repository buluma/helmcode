...
declare const __HELMCODE_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

export function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __HELMCODE_BUILD_CHANNEL__ === "undefined" ? "dev" : __HELMCODE_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Helm Code (Dev)",
  nightly: "Helm Code (Nightly)",
  latest: "Helm Code",
...
<html lang="en">
  <head>
    ...
    <title>HelmCode Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up HelmCode Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
