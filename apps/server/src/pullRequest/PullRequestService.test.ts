...
it.effect(
  ...
  () =>
    Effect.gen(function* () {
      ...
      assert.deepStrictEqual(listed, ["buluma/helmcode"]);
  ...
  () =>
    Effect.gen(function* () {
        ...
        providers: [
          fakeProvider("github", {
            listChangeRequests: ({ repository }) =>
              Effect.succeed({
                items: [changeRequest(1, "2026-07-02T00:00:00Z")],
                truncated: repository === "buluma/helmcode",
                continues: true,
              }),
          }),
        ],
      ...
      assert.deepStrictEqual(result.nextCursors, {
        "github.com buluma/helmcode": "2026-07-02T00:00:00Z|1|1",
      });
    }),
);
...
it.effect(
  ...
  () =>
    Effect.gen(function* () {
      ...
      const result = yield* service.list({
        state: "open",
        cursors: { "github.com buluma/helmcode": "2026-07-02T00:00:00Z|1|7" },
      });
      ...
      assert.deepStrictEqual(result.nextCursors, {
        "github.com buluma/helmcode": "2026-07-01T00:00:00Z|3|9",
      });
    }),
);
...
it.effect(
  ...
  () =>
    Effect.gen(function* () {
      ...
      const result = yield* service.list({
        state: "open",
        cursors: { "github.com buluma/helmcode": "2026-07-02T00:00:00Z|1|6" },
      });
      ...
      assert.deepStrictEqual(result.nextCursors, {
        "github.com buluma/helmcode": "2026-07-02T00:00:00Z|3|6,7,8",
      });
    }),
);
  ...
  () =>
    Effect.gen(function* () {
      ...
      const error = yield* Effect.flip(
        service.list({
          state: "open",
          cursors: { "github.com buluma/helmcode": "yesterday" },
        }),
      );
...
it.effect(
  "an explicit invalidation makes the next listing ask the host again",
  () =>
    Effect.gen(function* () {
      let hostCalls = 0;
      const service = yield* makeService({
...
it.effect(
  ...
  () =>
    Effect.gen(function* () {
      ...
      assert.deepStrictEqual(asked, [["buluma/helmcode", "acme/web"]]);
...
it.effect(
  ...
  () =>
    Effect.gen(function* () {
      ...
      assert.isTrue(result.truncated);
      assert.deepStrictEqual(result.nextCursors, {
        "github.com buluma/helmcode": "2026-07-02T00:00:00Z|1|2",
...
it.effect(
  "forgets the cached detail after a rewrite, like the other mutations",
  () =>
    Effect.gen(function* () {
      let coreCalls = 0;
      const reference = {
