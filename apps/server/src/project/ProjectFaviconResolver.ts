...
>()("helmcode/project/ProjectFaviconResolver") {}
...
export const make = Effect.gen(function* () {
  ...
  const projectFileLoader = yield* HelmCodeProjectFileLoader.HelmCodeProjectFileLoader;
  ...
  const resolvePathUncached = Effect.fn("ProjectFaviconResolver.resolvePathUncached")(function* (
    ...
    // A helmcode.json iconPath takes precedence over the well-known locations.
