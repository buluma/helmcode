import { ProjectId } from "@helmcode/contracts";
import { projectScriptRuntimeEnv, setupProjectScript } from "@helmcode/shared/projectScripts";
...
>()("helmcode/project/ProjectSetupScriptRunner") {}
