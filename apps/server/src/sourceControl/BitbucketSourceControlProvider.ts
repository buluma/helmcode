...
import { SourceControlProviderError, type ChangeRequest } from "@helmcode/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set HELMCODE_BITBUCKET_EMAIL and HELMCODE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
