...
import { isDevProxiedPath } from "@helmcode/shared/devProxy";
import { decodeOtlpTraceRecords } from "@helmcode/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["helmcode://app", "helmcode-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // HELMCODE_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
