...
export function buildResourceTelemetryHistory(
  ...
  for (const snapshot of snapshots) {
    ...
    aggregateSamples.push({
      ...
      cpuPercent: merged.groups.allHelmCode.currentCpuPercent,
      rssBytes: merged.groups.allHelmCode.currentRssBytes,
      processCount: merged.groups.allHelmCode.processCount,
