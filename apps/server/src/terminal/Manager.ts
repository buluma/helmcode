...
import { makeKeyedCoalescingWorker } from "@helmcode/shared/KeyedCoalescingWorker";
...
>()("helmcode/terminal/Manager/TerminalManager") {}
...
function shouldExcludeTerminalEnvKey(key: string): boolean {
  ...
  if (normalizedKey.startsWith("HELMCODE_")) {
    return true;
  }
...
// temporary mount (e.g. /tmp/.mount_HelmCode-XXXX/usr/bin, the bundled glib schemas,
