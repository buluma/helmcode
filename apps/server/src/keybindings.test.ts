import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@helmcode/contracts";
...
import { KeybindingsConfigError } from "@helmcode/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "helmcode-keybindings-test-",
        }),
      ),
    ),
  );
