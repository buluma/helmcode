...
import { isCommandAvailable, resolveSpawnCommand } from "@helmcode/shared/shell";
...
// per-command cache lookups in @helmcode/shared/shell.
//
...
// command-resolution cache in @helmcode/shared/shell, so a backward wall-clock
...
>()("helmcode/process/externalLauncher") {}
