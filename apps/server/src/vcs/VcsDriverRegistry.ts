...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@helmcode/contracts";
import { VcsUnsupportedOperationError } from "@helmcode/contracts";
...
>()("helmcode/vcs/VcsDriverRegistry") {}
