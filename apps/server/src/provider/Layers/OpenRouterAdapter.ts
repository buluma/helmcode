 ...
 * which are not transient, except 429 -- a rate limit clears up on its own
 * the same way a 5xx does, and failing the whole session on the first 429
 * (as observed in production logs) needlessly kills a turn that would have
 * gone through moments later.
 */
