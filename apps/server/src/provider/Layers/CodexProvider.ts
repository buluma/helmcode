...
import { PREFERRED_DEFAULT_CODEX_MODELS, ServerSettingsError } from "@helmcode/contracts";
...
const CODEX_PRESENTATION = {
  ...
  supportsMultiAgentWorkflow: true,
} as const;
...
export function buildCodexInitializeParams(): CodexSchema.V1InitializeParams {
  return {
    clientInfo: {
      name: "helmcode_desktop",
      title: "Helm Code Desktop",
