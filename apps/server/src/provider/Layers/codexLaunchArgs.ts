import { tokenizeCliArgs } from "@helmcode/shared/cliArgs";

export const HELMCODE_CODEX_LAUNCH_ARGS_ENV = "HELMCODE_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[HELMCODE_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
