import { type GrokSettings, ProviderDriverKind } from "@helmcode/contracts";
...
import { normalizeModelSlug } from "@helmcode/shared/model";
...
const HELM_CODE_OAUTH_REFERRER = "helmcode";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: HELM_CODE_OAUTH_REFERRER,
    },
  };
}
