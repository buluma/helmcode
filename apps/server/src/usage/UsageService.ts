 ...
 *
 * The scan reads the provider CLIs' own session files rather than Helm Code's
 * orchestration projections, so usage covers turns driven outside Helm Code too.
