...
import HelmCodeMarkdownTextRunNativeComponent from "./HelmCodeMarkdownTextRunNativeComponent";
import HelmCodeMarkdownTextNativeComponent from "./HelmCodeMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({ style, children, ...rest }: MarkdownTextPrimitiveProps) {
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <HelmCodeMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <HelmCodeMarkdownTextNativeComponent
          {...textDefaults}
          {...rest}
