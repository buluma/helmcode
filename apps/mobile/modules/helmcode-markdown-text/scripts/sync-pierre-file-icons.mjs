...
const customSprite = webIconSource.match(/const HELMCODE_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error("Could not read the HelmCode Pierre icon sprite from apps/web/src/pierre-icons.ts");
}
...
const customIcons = {
  agents: "helmcode-file-icon-agents",
  claude: "helmcode-file-icon-claude",
  package: "helmcode-file-icon-package-json",
  pnpm: "helmcode-file-icon-pnpm",
  readme: "helmcode-file-icon-readme",
  tsconfig: "helmcode-file-icon-tsconfig",
};
