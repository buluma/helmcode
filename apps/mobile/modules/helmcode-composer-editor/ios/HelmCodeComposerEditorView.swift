...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "helmcode-composer-paste"
...
public final class HelmCodeComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate {
