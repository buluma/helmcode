...
import type { SidebarProjectGroupingMode } from "@helmcode/contracts";

import * as MobileDatabase from "./mobile-database";
import * as MobileSecureStorage from "./mobile-secure-storage";
import { MobileStorageDecodeError, MobileStorageEncodeError } from "./mobile-storage";

const PREFERENCES_KEY = "helmcode.preferences";
const PREFERENCES_FALLBACK_KEY = "helmcode.preferences.fallback";
...
>()("@helmcode/mobile/persistence/MobilePreferencesStore") {}
