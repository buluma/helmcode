...
const CONNECTIONS_KEY = "helmcode.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "helmcode.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "helmcode.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "helmcode.recent-thread-shortcuts";
...
>()("@helmcode/mobile/persistence/MobileStorage") {}
