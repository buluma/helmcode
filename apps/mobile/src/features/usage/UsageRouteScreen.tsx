...
import type { DailyTotals, MergedUsage } from "@helmcode/shared/usageMerge";
import {
  enumerateDays,
  enumerateHourStarts,
  formatCount,
  ...
  formatUsd,
  makeWindow,
} from "@helmcode/shared/usageFormat";
      ...
      {props.options.map((option) => {
        ...
        return (
          ...
          >
            <Text
              className={
                active ? "text-sm font-helmcode-medium text-foreground" : "text-sm text-foreground-muted"
              }
            >
              {option.label}
            </Text>
    ...
    <View className="gap-4 rounded-[24px] border-continuous bg-card p-4">
      <View className="flex-row items-start justify-between gap-3">
        <View className="min-w-0 flex-1 gap-0.5">
          ...
          <Text className="text-4xl font-helmcode-bold tabular-nums text-foreground">
        ...
        return (
          ...
          >
            <Text
              className={
                active
                  ? "text-xs font-helmcode-medium uppercase text-foreground"
...
function MetricCell(props: {
  ...
  return (
    <View className="w-1/2 gap-0.5 p-4">
      ...
      <Text className="text-xl font-helmcode-medium tabular-nums text-foreground">{props.value}</Text>
