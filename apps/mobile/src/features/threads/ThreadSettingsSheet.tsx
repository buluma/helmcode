...
function ModelRow(props: {
  ...
  return (
    ...
    >
      <Text
        className={cn(
          "shrink text-sm font-helmcode-medium",
      ...
      {props.option.isDefault ? (
        <View className="rounded-md bg-subtle-strong px-1.5 py-0.5">
          <Text className="text-3xs font-helmcode-bold text-foreground-muted">Default</Text>
        </View>
      ) : null}
      {props.option.isLegacy ? (
        <View className="rounded-md bg-subtle px-1.5 py-0.5">
          <Text className="text-3xs font-helmcode-bold text-foreground-muted">Legacy</Text>
        </View>
      ) : null}
...
function ProviderHeader(props: {
  ...
  return (
    ...
    >
      ...
      <Text className="text-2xs font-helmcode-bold uppercase tracking-widest text-foreground-muted">
        {props.label}
      </Text>
      {props.collapsible ? (
        <>
          <View className="flex-1" />
          {props.collapsed ? (
            <Text className="text-2xs font-helmcode-medium text-foreground-muted">
              {props.modelCount}
            </Text>
          ) : null}
          <SymbolView
...
function DisclosureRow(props: {
  ...
  return (
    ...
    >
      <Text className="text-sm font-helmcode-medium text-foreground">{props.label}</Text>
      <View className="flex-1" />
      {props.value ? (
      ...
      <View className="flex-1 justify-end">
        ...
        >
          ...
          <View style={{ paddingBottom: insets.bottom + 12 }}>
            ...
            >
              <Text className="text-sm font-helmcode-bold text-primary-foreground">
        ...
        {submenuContent ? (
          <View className="absolute inset-0 justify-end">
            ...
            <View className="overflow-hidden rounded-t-[24px] border border-b-0 border-border bg-sheet">
              ...
              <Text className="px-5 pb-1.5 text-2xs font-helmcode-bold uppercase tracking-widest text-foreground-muted">
