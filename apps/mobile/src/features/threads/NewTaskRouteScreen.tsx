...
import type { EnvironmentProject } from "@helmcode/client-runtime/state/shell";
      ...
      >
        {projectScopes.length === 0 ? (
          <View collapsable={false} className="items-center gap-3 rounded-[24px] bg-card px-6 py-8">
            ...
            <Text className="text-center text-lg font-helmcode-bold text-foreground">
                ...
                >
                  ...
                  >
                    ...
                    <View className="min-w-0 flex-1">
                      <Text className="text-base leading-snug font-helmcode-bold">{scope.title}</Text>
                      <Text
                  ...
                  {hasMultipleProjects && expanded
                    ? scope.projects.map((project) => (
                        ...
                        >
                          ...
                          />
                          <View className="min-w-0 flex-1">
                            <Text className="text-sm font-helmcode-bold text-foreground">
                              {project.title}
                            </Text>
                            <Text
