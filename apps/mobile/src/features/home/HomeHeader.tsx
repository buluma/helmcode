            ...
            <WorkspaceConnectionTitle
              ...
              brand={
                <View className="flex-row items-center gap-2">
                  {/* Mirrors the desktop SidebarBrand: Helm mark + muted "Code". */}
                  <RNText
                    className="text-[21px] font-helmcode-medium tracking-[-0.5px]"
                    style={{ color: iconColor }}
                  >
                    Helm
                  </RNText>
                  <RNText className="-ml-0.5 text-[21px] font-helmcode-medium tracking-[-0.5px] text-foreground-muted">
                    Code
                  </RNText>
                  <View className="rounded-full bg-subtle px-2 py-0.75">
                    <RNText className="text-[11px] font-helmcode-bold tracking-[1.1px] text-foreground-muted uppercase">
                      {stageLabel}
                    </RNText>
                  </View>
                </View>
