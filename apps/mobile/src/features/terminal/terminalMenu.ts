import { type KnownTerminalSession } from "@helmcode/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@helmcode/contracts";
...
} from "@helmcode/shared/terminalLabels";
