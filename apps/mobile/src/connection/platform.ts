...
import { AuthStandardClientScopes } from "@helmcode/contracts";
        ...
        clerkToken: Effect.gen(function* () {
          ...
          if (session === null) {
            return yield* new ConnectionBlockedError({
              ...
              detail: "Sign in to HelmCode Connect to connect this environment.",
            });
          }
          ...
          if (token === null) {
            return yield* new ConnectionBlockedError({
              reason: "authentication",
              detail: "The HelmCode Connect session is unavailable.",
            });
          }
          return token;
        }),
