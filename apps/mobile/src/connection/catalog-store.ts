...
} from "@helmcode/client-runtime/platform";
import { ConnectionTransientError } from "@helmcode/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "helmcode.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "helmcode.connections";
