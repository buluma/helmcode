...
function RootStackLayout(props: {
  ...
  // Presents the HelmCode Connect onboarding sheet after an in-session sign-in.
...
function NotFoundScreen() {
  ...
  return (
    ...
    >
      <Text className="text-3xl font-helmcode-bold text-foreground" selectable>
        Route not found
      </Text>
      <Pressable
      ...
      >
        <Text className="text-base font-helmcode-bold text-primary-foreground">Return home</Text>
      </Pressable>
    </ScrollView>
  );
}
