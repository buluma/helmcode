import { isTransportConnectionErrorMessage } from "@helmcode/client-runtime/errors";
import type { EnvironmentShellStatus } from "@helmcode/client-runtime/state/shell";
import {
  CommandId,
  EnvironmentId,
  IsoDateTime,
