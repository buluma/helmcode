...
import { EnvironmentProject, EnvironmentThreadShell } from "@helmcode/client-runtime/state/shell";
import type { AtomCommandResult } from "@helmcode/client-runtime/state/runtime";
import {
  type GitActionRequestInput,
  type VcsActionOperation,
  type VcsRef,
} from "@helmcode/client-runtime/state/vcs";
import type { GitRunStackedActionResult } from "@helmcode/contracts";
import {
