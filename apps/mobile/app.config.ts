...
const isIosPersonalTeamBuild = repoEnv.HELMCODE_IOS_PERSONAL_TEAM === "1";

const personalTeamBundleIdentifier = repoEnv.HELMCODE_IOS_PERSONAL_TEAM_BUNDLE_ID?.trim();
...
if (
  ...
  throw new Error(
    "HELMCODE_IOS_PERSONAL_TEAM_BUNDLE_ID must be a reverse-DNS identifier such as com.example.helmcode when HELMCODE_IOS_PERSONAL_TEAM=1.",
  );
}
...
const VARIANT_CONFIG = {
  development: {
    appName: "Helm Code Dev",
    scheme: "helmcode-dev",
    iosBundleIdentifier: "com.helmcode.helmcode.dev",
    androidPackage: "com.helmcode.helmcode.dev",
    relyingParty: "clerk.t3.codes",
    assets: DEVELOPMENT_ASSETS,
  },
  preview: {
    appName: "Helm Code Preview",
    scheme: "helmcode-preview",
    iosBundleIdentifier: "com.helmcode.helmcode.preview",
    androidPackage: "com.helmcode.helmcode.preview",
    relyingParty: "clerk.t3.codes",
  ...
  production: {
    appName: "Helm Code",
    scheme: "helmcode",
    iosBundleIdentifier: "com.helmcode.helmcode",
    androidPackage: "com.helmcode.helmcode",
    relyingParty: "clerk.t3.codes",
    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Helm Code agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    requireFullScreen: process.env.HELMCODE_SHOWCASE_CAPTURE_BUILD === "1",
    bundleIdentifier: iosBundleIdentifier,
    // Pin code signing to the HelmCode Tools team so non-interactive `expo run:ios`
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Helm Code to connect to Helm Code servers on your local network or tailnet.",
      ...
      ...(process.env.HELMCODE_SHOWCASE_CAPTURE_BUILD === "1"
        ? {
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow Helm Code to access your camera so you can scan pairing QR codes.",
  ...
  extra: {
    ...
    relay: {
      url: repoEnv.HELMCODE_RELAY_URL ?? null,
    },
    clerk: {
