...
import { resolveRemoteHelmCodeCliPackageSpec } from "@helmcode/ssh/command";
import type { RemoteHelmCodeRunnerOptions } from "@helmcode/ssh/tunnel";
...
const resolveDesktopSshCliRunner = (
...
): RemoteHelmCodeRunnerOptions => {
  const devRemoteEntryPath = Option.getOrUndefined(environment.devRemoteHelmCodeServerEntryPath);
  ...
  return {
    packageSpec: resolveRemoteHelmCodeCliPackageSpec({
