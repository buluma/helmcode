...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    readonly devRemoteHelmCodeServerEntryPath: Option.Option<string>;
...
>()("@helmcode/desktop/app/DesktopEnvironment") {}

const APP_BASE_NAME = "Helm Code";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = resolveDesktopBaseDir({
    homeDirectory,
    joinPath: path.join,
    helmcodeHome: config.helmcodeHome,
  });
  ...
  const userDataDirName = isDevelopment ? "helmcode-dev" : "helmcode";
  const legacyUserDataDirName = isDevelopment ? "Helm Code (Dev)" : "Helm Code (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    devServerUrl,
    devRemoteHelmCodeServerEntryPath: config.devRemoteHelmCodeServerEntryPath,
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.helmcode.helmcode.dev" : "com.helmcode.helmcode",
    ),
    linuxDesktopEntryName: isDevelopment ? "helmcode-dev.desktop" : "helmcode.desktop",
    linuxWmClass: isDevelopment ? "helmcode-dev" : "helmcode",
