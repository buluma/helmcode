import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@helmcode/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@helmcode/shared/observability";
...
>()("@helmcode/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
