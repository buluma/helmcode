...
>()("@helmcode/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__HELMCODE_ENV_${name}_START__`;
const endMarker = (name: string) => `__HELMCODE_ENV_${name}_END__`;
