...
import { waitForHttpReady as waitForHttpReadyShared } from "@helmcode/shared/httpReadiness";
...
const BACKEND_READINESS_PATH = "/.well-known/helmcode/environment";
...
export interface DesktopBackendStartConfig extends BackendProcessContext {
  ...
  // HELMCODE_HOME can't pin the WSL backend to /mnt/c/...\.helmcode.
