import { type ServerLifecycleWelcomePayload } from "@helmcode/contracts";
import { scopedProjectKey, scopeProjectRef } from "@helmcode/client-runtime/environment";
import { squashAtomCommandFailure } from "@helmcode/client-runtime/state/runtime";
import {
  Outlet,
  createRootRoute,
