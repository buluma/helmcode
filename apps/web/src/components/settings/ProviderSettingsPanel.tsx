...
import { safeErrorLogAttributes } from "@helmcode/client-runtime/errors";
import {
...
import { DEFAULT_UNIFIED_SETTINGS } from "@helmcode/contracts/settings";
import {
  getBackgroundActivityPresetSettings,
  resolveServerBackgroundActivitySettings,
} from "@helmcode/shared/backgroundActivitySettings";
...
function providerEnvironmentDetail(environment: EnvironmentPresentation): string {
  ...
  if (environment.relayManaged) return "HelmCode Connect";
