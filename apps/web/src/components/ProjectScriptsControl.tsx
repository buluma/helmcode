...
const NO_FILE_SCRIPTS: ReadonlyArray<HelmCodeProjectFileScript> = [];

interface ProjectScriptsControlProps {
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in helmcode.json, offered for import. */
  fileScripts?: ReadonlyArray<HelmCodeProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: HelmCodeProjectFileScript) => {
  ...
  const importMenuItems = importableScripts.length > 0 && (
    <>
      ...
      <MenuGroup>
        <MenuGroupLabel>From helmcode.json</MenuGroupLabel>
