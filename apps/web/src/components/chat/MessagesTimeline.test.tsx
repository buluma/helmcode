import { CheckpointRef, EnvironmentId, MessageId, TurnId } from "@helmcode/contracts";
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/helmcode/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/helmcode"
      />,
    );

    expect(markup).toContain("helmcode/apps/web/src/session-logic.ts");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/helmcode/apps/web/src/session-logic.ts");
  });
