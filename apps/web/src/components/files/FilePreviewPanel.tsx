...
import { isWorkspaceImagePreviewPath } from "@helmcode/shared/filePreview";
...
const FILE_EXPLORER_STORAGE_KEY = "helmcode.fileExplorerOpen";
const RENDER_MARKDOWN_STORAGE_KEY = "helmcode.renderMarkdown";
