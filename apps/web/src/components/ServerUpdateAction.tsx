import type { EnvironmentId, ServerSelfUpdateCapability } from "@helmcode/contracts";
import type { ServerUpdateStage, ServerUpdateState } from "@helmcode/client-runtime/state/server";
import {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      toastManager.add({
        ...
        description: `Reconnected on helmcode@${result.value.targetVersion}.`,
      });
    } finally {
