...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@helmcode/contracts";
...
/**
 * Post-sign-in onboarding wizard for HelmCode Connect. Opens on every in-session
 ...
 * account's HelmCode Connect environments so every device can be connected right
...
function ConfiguredConnectOnboardingDialog() {
  ...
  const applyPublishSelection = async () => {
    ...
    toastManager.add({
      type: "success",
      title: "HelmCode Connect enabled",
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up HelmCode Connect</DialogTitle>
          <DialogDescription>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through HelmCode Connect."
