...
import type { EnvironmentThreadShell } from "@helmcode/client-runtime/state/models";
import {
  scopeProjectRef,
  scopeThreadRef,
  scopedThreadKey,
} from "@helmcode/client-runtime/environment";
import type { ScopedThreadRef, ThreadId } from "@helmcode/contracts";
...
const SETTLED_SHELF_EXPANDED_KEY = "helmcode:sidebar-v2:settled-expanded";
const SNOOZED_SHELF_EXPANDED_KEY = "helmcode:sidebar-v2:snoozed-expanded";
...
const SidebarThreadRow = memo(function SidebarThreadRow(props: {
  ...
  // browser. A plain click still opens HelmCode's pull request view.
  const prBadge =
    prStatus && pr ? (
      <a
        href={pr.url}
