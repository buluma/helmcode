...
import { DEFAULT_RUNTIME_MODE, type ScopedProjectRef, type ThreadId } from "@helmcode/contracts";
...
import { resolveDefaultThreadEnvMode } from "@helmcode/shared/threadEnvMode";
import { readThreadShell, useProjects, useThread } from "../state/entities";
import { resolveNewDraftStartFromOrigin } from "../lib/chatThreadActions";
import { readHelmCodeProjectFileDefaultThreadEnvMode } from "../lib/helmcodeProjectFileDefaults";
...
export function useNewThreadHandler() {
  ...
  return useCallback(
    (
      ...
      // The shared resolver owns the priority order. The helmcode.json read is
      ...
      const resolveDefaultEnvMode = async (): Promise<DraftThreadEnvMode> => {
        ...
        return resolveDefaultThreadEnvMode({
          ...
          projectFile: consultProjectFile
            ? await readHelmCodeProjectFileDefaultThreadEnvMode(
