...
export class GhosttyTerminalSurface {
  ...
  static async create(
    ...
    canvas.className = "helmcode-ghostty-canvas";
    canvas.style.cssText = "display:block;width:100%;height:100%;";
    canvas.setAttribute("aria-hidden", "true");

    const input = document.createElement("textarea");
    input.className = "helmcode-ghostty-input";
    ...
    scrollbar.className = "helmcode-ghostty-scrollbar";
    ...
    scrollbarThumb.className = "helmcode-ghostty-scrollbar-thumb";
