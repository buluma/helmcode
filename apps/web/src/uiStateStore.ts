...
export const PERSISTED_STATE_KEY = "helmcode:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "helmcode:renderer-state:v8",
  "helmcode:renderer-state:v7",
  "helmcode:renderer-state:v6",
  "helmcode:renderer-state:v5",
  "helmcode:renderer-state:v4",
  "helmcode:renderer-state:v3",
