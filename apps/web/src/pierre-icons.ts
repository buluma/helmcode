...
const PIERRE_ICON_SPRITE_ID = "helmcode-pierre-file-icon-sprite";

const HELMCODE_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="helmcode-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="helmcode-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="helmcode-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="helmcode-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="helmcode-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="helmcode-file-icon-pnpm" viewBox="0 0 32 32">
...
export const HELMCODE_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: HELMCODE_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "helmcode-file-icon-package-json",
    "tsconfig.json": "helmcode-file-icon-tsconfig",
    "agents.md": "helmcode-file-icon-agents",
    "claude.md": "helmcode-file-icon-claude",
    "readme.md": "helmcode-file-icon-readme",
    "pnpm-lock.yaml": "helmcode-file-icon-pnpm",
    "pnpm-workspace.yaml": "helmcode-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(HELMCODE_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${HELMCODE_FILE_ICON_SPRITE}`;
