...
import { RelayWebClientId } from "@helmcode/contracts/relay";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_HELMCODE_RELAY_URL", "https://relay.example.test");
