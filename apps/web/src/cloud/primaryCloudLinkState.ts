...
import type { EnvironmentCloudLinkStateResult } from "@helmcode/contracts";
...
export function usePrimaryCloudLinkState() {
  ...
  if (result._tag === "Failure") {
    ...
    error = cause instanceof Error ? cause.message : "Could not read HelmCode Connect link state.";
  }
