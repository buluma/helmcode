...
> = {
  ...
  bitbucket: {
    missing:
      "Bitbucket needs API credentials on the server. Set HELMCODE_BITBUCKET_EMAIL and HELMCODE_BITBUCKET_API_TOKEN, or HELMCODE_BITBUCKET_ACCESS_TOKEN.",
    unauthenticated:
      "Bitbucket rejected the configured credentials. Check HELMCODE_BITBUCKET_EMAIL and HELMCODE_BITBUCKET_API_TOKEN.",
  },
};
