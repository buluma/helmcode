...
/** What update path a client should offer for a server: one of the RPC
    ...
    version belongs to the Helm Code desktop app supervising it — updating the
...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server understands thread.schedule.create / thread.schedule.cancel commands. Same
      version-skew contract as threadSettlement. */
  threadScheduling: Schema.optionalKey(Schema.Boolean),
