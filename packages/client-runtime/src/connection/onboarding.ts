import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@helmcode/contracts";
import { resolveRemotePairingTarget } from "@helmcode/shared/remote";
...
>()("@helmcode/client-runtime/connection/onboarding/ConnectionOnboarding") {}
