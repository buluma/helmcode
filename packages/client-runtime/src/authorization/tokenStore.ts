...
import { RelayManagedEndpoint } from "@helmcode/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@helmcode/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@helmcode/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
