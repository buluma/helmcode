 ...
 *
 * ```ts
 * import { parseYaml } from "@helmcode/shared/schemaYaml"
 *
 ...
 *
 * ```ts
 * import { stringifyYaml } from "@helmcode/shared/schemaYaml"
 *
 ...
 * ```ts
 * import * as Schema from "effect/Schema"
 * import { fromYamlString } from "@helmcode/shared/schemaYaml"
 *
