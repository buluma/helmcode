...
export const RELAY_LINK_PROOF_TYP = "helmcode-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "helmcode-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "helmcode-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "helmcode-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "helmcode-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "helmcode-env-activity+jwt";
