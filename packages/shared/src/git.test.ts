import type { VcsStatusRemoteResult, VcsStatusResult } from "@helmcode/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:HelmCode/HelmCode.git")).toBe(
      "github.com/helmcode/helmcode",
    );
    expect(normalizeGitRemoteUrl("https://github.com/HelmCode/HelmCode.git")).toBe(
      "github.com/helmcode/helmcode",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/HelmCode/HelmCode")).toBe(
      "github.com/helmcode/helmcode",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:HelmCode/platform/HelmCode.git")).toBe(
      "gitlab.com/helmcode/platform/helmcode",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/HelmCode/platform/HelmCode.git")).toBe(
      "gitlab.com/helmcode/platform/helmcode",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:HelmCode/HelmCode.git"),
    ).toBe("HelmCode/HelmCode");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/HelmCode/HelmCode.git"),
    ).toBe("HelmCode/HelmCode");
  });
});
