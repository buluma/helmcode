import type { ThreadEnvMode } from "@helmcode/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in helmcode.json > global server setting.
 *
 ...
 * source that outranks helmcode.json decided, or the file read settled. While
